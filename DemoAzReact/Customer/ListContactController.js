...
export default class ListContactController extends Component { 
    ...
    fetch(url, {
      ...
      searchFilterFunction = text => {
        ...
        const newData = this.arrayholder.filter(item => {
          const itemData = `${[item.tenkh.toUpperCase()]} ${[item.email.toUpperCase()]} ${[item.maso.toUpperCase()]} ${[item.didong.toUpperCase()]}`;
